...
const Cart = (props)=>{
  ...
  const renderView = () => {
    ...
    return (
      <Text style = {styles.TextStyles1} onPress={() => {setItemsViewLimit(idsSet.length),setChangeView(true)}}>
        Show More
      </Text>
    )
  }
  ...
  return (
    <>
      ...
      <View style = {styles.totalCostView}>
        <Text style ={styles.totalCostText1}>Total Cost</Text>
        <Text  style ={{textAlign:'center',fontSize:18}}>€{`${totalCost}`}</Text>
      </View>
      <Text style = {styles.ReviewOrdersText}>Review Orders</Text>
        ...
        <ScrollView>
          {
            limitedIdsSet.map((id) => {
              ...
              return (
                ...
                <View key={id} style = {styles.ViewStyles1}>
                  <View>
                  ...
                  <View style = {{flexDirection:'column',padding:10}}>
                    ...
                    <Text style = {{color:'#FCBC98',fontSize:14,top:2}}>€{dishObj.price}</Text>
                  </View>
                  ...
                  <View style = {styles.quantityUpdatedView}>
                    ...
                    <TouchableOpacity  style={styles.addItemToCartView}
                      onPress={() => { dishObjLength < 20 && addItemToCart(dishObj)}}
                    >
                      <Image source = {require('../../assets/plus.png')} style = {styles.ImageStyles1}/>
                    </TouchableOpacity>
                  </View> 
                  <Image source = {require('../../assets/chat.png')} style = {styles.ImageStyles2}/>
                </View>
              )
            } 
          )
